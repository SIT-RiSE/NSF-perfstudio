...
const researchAssistants = [
  {
    ...
    bio: 'Research focuses on unit testing and developer automation, emphasizing the Arrange–Act–Assert (AAA) structure in test suites. Published empirical study on unit test structure in IEEE TSE. Also develops LLM-based agents including Setup AGent (SAG) for Java project configuration (ICSE 2026 NIER).',
    initials: 'CW',
  },
  {
