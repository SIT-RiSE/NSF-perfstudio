...
const resourceCategories = [
  {
    ...
    description: 'Unit 1 materials covering SPE process, Java I/O performance, and OO design trade-offs.',
    status: 'available',
    materials: [
      { name: 'Lecture Slides', type: 'PPTX', path: './materials/315/SSW315-lecture.pptx', size: '~3 MB' },
      { name: 'PBL Activity Document', type: 'PDF', path: './materials/315/SSW315-assignment.pdf', size: '~500 KB' },
      { name: 'Exit Survey Template', type: 'PDF', path: './materials/315/SSW315-survey.pdf', size: '~200 KB' },
    ],
  },
  {
  ...
  },
  {
    ...
    description: 'Unit 4 materials focusing on ROI analysis of Apache open-source project performance issues.',
    status: 'available',
    materials: [
      { name: 'Guest Lecture Slides', type: 'PDF', path: './materials/GuestLecturePerformanceFor533.pdf', size: '~2 MB' },
      { name: 'PBL Activity Document', type: 'HTML', path: './materials/SSW5331028Activity.html', size: '~50 KB' },
      { name: 'Exit Survey Template', type: 'HTML', path: './materials/ROIAnalysisSurvey.html', size: '~30 KB' },
    ],
    batches: [
  ...
  },
  {
    ...
    description: 'Unit 5 materials covering performance testing, reliability testing, and comprehensive test planning.',
    status: 'available',
    materials: [
      { name: 'Lecture Slides', type: 'PDF', path: './materials/567/SSW567-lecture.pdf', size: '~2 MB' },
      { name: 'PBL Activity Document', type: 'DOCX', path: './materials/567/SSW567-project.docx', size: '~400 KB' },
    ],
    surveyLink: 'https://stevens.qualtrics.com/jfe/form/SV_0Umyn32iIvhH0zA',
  },
]
              ...
              >
                ...
                {category.status === 'available' && (
                  <div className="p-6">
                    ...
                    <div className="space-y-3 mb-6">
                      {category.materials.map((material) => (
                        ...
                        >
                          ...
                          <a
                            href={material.path}
                            download={['PDF', 'PPTX', 'DOCX'].includes(material.type)}
                          ...
                          >
                            {material.type === 'HTML' ? 'View' : 'Download'}
                    ...
                    {/* Survey Link */}
                    {'surveyLink' in category && category.surveyLink && (
                      <div className="mb-6 p-3 bg-[var(--color-highlight)] border border-[var(--color-accent-warm)]/20">
                        <div className="flex items-center justify-between">
                          <span className="text-sm text-[var(--color-ink)]">Exit Survey (Online)</span>
                          <a
                    ...
                    {/* ROI Batches */}
                    {'batches' in category && category.batches && (
                      <>
                        <h3 className="font-semibold text-[var(--color-ink)] text-sm mb-4">
                          ROI Analysis Batches (50 Issue Tickets from Apache Projects)
                        </h3>
